...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      has_event_access: { Args: { event_uuid: string }; Returns: boolean }
      is_event_admin: { Args: { event_uuid: string }; Returns: boolean }
      is_session_host: { Args: { session_uuid: string }; Returns: boolean }
    }
    Enums: {
      [_ in never]: never
    }
